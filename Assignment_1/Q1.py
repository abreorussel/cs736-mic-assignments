...
def check_nearby_parameters(alpha =0 , gamma = 0, prior ="quadratic"):
	if prior == "quadratic":
		_, _, rrmse_optimal = optimize(imageNoiseless, imageNoisy, alpha=alpha, gamma=gamma, likelihood="gaussian", prior=prior ,print_log =False)
...
if __name__ == "__main__":
	...
	# check_nearby_parameters(alpha=1.2*1.2*1.2*0.6482, gamma=0.8*0.8*0.07939, prior="adaptive")
