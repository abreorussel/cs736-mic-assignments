...
def optimize(x_true ,y_observed, step_size=1e-2, iterations=200, alpha=0.5, gamma=0, likelihood="gaussian", prior="quadratic"):
	# print(f"ALpha : {alpha}")
	max_threshold = 2.5
	min_threshold = 0.001
	max_step_size = 1e-1
...
if __name__ == "__main__":
	...
	optimize(imageNoiseless, imageNoisy, alpha=0.05, gamma=0.5, likelihood="gaussian", prior="quadratic")
